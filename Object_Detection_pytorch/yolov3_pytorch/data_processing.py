...
import numpy as np
import io
# yolov3-car-tiny-obj.trt has been trained for detection of car:
...
class PreprocessYOLO(object):
    ...
    input resolution for YOLOv3-416.
    """
